...
const softkey_param Input::softkey_full[66 + 1] = {
    ...
    { 8 + 5 * 0, 12 + 7 * 4, 4, 6, 1, "\xb6"
                                      "\xc5",
      (int)SDL_SCANCODE_SCROLLLOCK },
    ...
    { 8 + 5 * 2, 12 + 7 * 4, 9, 6, 1, "SPACE\n"
                                      ...
                                      "\x92"
                                      "\xe8",
      (int)SDL_SCANCODE_INTERNATIONAL4 },
    ...
    { 8 + 5 * 6 + 2, 12 + 7 * 4, 12, 6, 1, "SPACE\n"
                                           ...
                                           "\x8a"
                                           "\xb7",
      (int)SDL_SCANCODE_INTERNATIONAL3 },
    { 8 + 5 * 9, 12 + 7 * 4, 4, 6, 1, "PC", (int)SDL_SCANCODE_INTERNATIONAL1 },
    { 8 + 5 * 10, 12 + 7 * 4, 4, 6, 1, "\x91"
                                       "\x53"
                                       "\n"
                                       "\x8a"
                                       "\x70",
      (int)SDL_SCANCODE_INTERNATIONAL2 },
...
const softkey_param Input::softkey_functen[35 + 1] = {
    ...
    { 2 + 7 * 0 + 9 * 0, 12 + 7 * 3, 8, 6, 1, "f"
                                              "\xa5"
                                              "1",
      (int)SDL_SCANCODE_F1 },
    { 2 + 7 * 0 + 9 * 1, 12 + 7 * 3, 8, 6, 1, "f"
                                              "\xa5"
                                              "2",
      (int)SDL_SCANCODE_F2 },
    { 2 + 7 * 0 + 9 * 2, 12 + 7 * 3, 8, 6, 1, "f"
                                              "\xa5"
                                              "3",
      (int)SDL_SCANCODE_F3 },
    { 2 + 7 * 0 + 9 * 3, 12 + 7 * 3, 8, 6, 1, "f"
                                              "\xa5"
                                              "4",
      (int)SDL_SCANCODE_F4 },
    { 2 + 7 * 0 + 9 * 4, 12 + 7 * 3, 8, 6, 1, "f"
                                              "\xa5"
                                              "5",
      (int)SDL_SCANCODE_F5 },

    { 2 + 7 * 0 + 9 * 0, 12 + 7 * 4, 8, 6, 1, "f"
                                              "\xa5"
                                              "6",
      (int)SDL_SCANCODE_F6 },
    { 2 + 7 * 0 + 9 * 1, 12 + 7 * 4, 8, 6, 1, "f"
                                              "\xa5"
                                              "7",
      (int)SDL_SCANCODE_F7 },
    { 2 + 7 * 0 + 9 * 2, 12 + 7 * 4, 8, 6, 1, "f"
                                              "\xa5"
                                              "8",
      (int)SDL_SCANCODE_F8 },
    { 2 + 7 * 0 + 9 * 3, 12 + 7 * 4, 8, 6, 1, "f"
                                              "\xa5"
                                              "9",
      (int)SDL_SCANCODE_F9 },
    { 2 + 7 * 0 + 9 * 4, 12 + 7 * 4, 8, 6, 1, "f"
                                              "\xa5"
                                              "10",
      (int)SDL_SCANCODE_F10 },
...
const softkey_param Input::softkey_tenfunc[35 + 1] = {
    ...
    { 33 + 7 * 0 + 9 * 0, 12 + 7 * 3, 8, 6, 1, "f"
                                               "\xa5"
                                               "1",
      (int)SDL_SCANCODE_F1 },
    { 33 + 7 * 0 + 9 * 1, 12 + 7 * 3, 8, 6, 1, "f"
                                               "\xa5"
                                               "2",
      (int)SDL_SCANCODE_F2 },
    { 33 + 7 * 0 + 9 * 2, 12 + 7 * 3, 8, 6, 1, "f"
                                               "\xa5"
                                               "3",
      (int)SDL_SCANCODE_F3 },
    { 33 + 7 * 0 + 9 * 3, 12 + 7 * 3, 8, 6, 1, "f"
                                               "\xa5"
                                               "4",
      (int)SDL_SCANCODE_F4 },
    { 33 + 7 * 0 + 9 * 4, 12 + 7 * 3, 8, 6, 1, "f"
                                               "\xa5"
                                               "5",
      (int)SDL_SCANCODE_F5 },

    { 33 + 7 * 0 + 9 * 0, 12 + 7 * 4, 8, 6, 1, "f"
                                               "\xa5"
                                               "6",
      (int)SDL_SCANCODE_F6 },
    { 33 + 7 * 0 + 9 * 1, 12 + 7 * 4, 8, 6, 1, "f"
                                               "\xa5"
                                               "7",
      (int)SDL_SCANCODE_F7 },
    { 33 + 7 * 0 + 9 * 2, 12 + 7 * 4, 8, 6, 1, "f"
                                               "\xa5"
                                               "8",
      (int)SDL_SCANCODE_F8 },
    { 33 + 7 * 0 + 9 * 3, 12 + 7 * 4, 8, 6, 1, "f"
                                               "\xa5"
                                               "9",
      (int)SDL_SCANCODE_F9 },
    { 33 + 7 * 0 + 9 * 4, 12 + 7 * 4, 8, 6, 1, "f"
                                               "\xa5"
                                               "10",
      (int)SDL_SCANCODE_F10 },
...
const softkey_param Input::softkey_actmove[14 + 1] = {
    ...
    { 50 + 7 * 1, 8 + 7 * 2, 6, 6, 1, "4"
                                      "\xa5"
                                      "8",
      (int)SDL_SCANCODE_KP_4 << 8 | (int)SDL_SCANCODE_KP_8 },
    { 50 + 7 * 2, 8 + 7 * 2, 6, 6, 4, "8", (int)SDL_SCANCODE_KP_8 },
    { 50 + 7 * 3, 8 + 7 * 2, 6, 6, 1, "6"
                                      "\xa5"
                                      "8",
      (int)SDL_SCANCODE_KP_6 << 8 | (int)SDL_SCANCODE_KP_8 },

    { 50 + 7 * 1, 8 + 7 * 3, 6, 6, 4, "4", (int)SDL_SCANCODE_KP_4 },
    { 50 + 7 * 3, 8 + 7 * 3, 6, 6, 4, "6", (int)SDL_SCANCODE_KP_6 },

    { 50 + 7 * 1, 8 + 7 * 4, 6, 6, 1, "4"
                                      "\xa5"
                                      "2",
      (int)SDL_SCANCODE_KP_4 << 8 | (int)SDL_SCANCODE_KP_2 },
    { 50 + 7 * 2, 8 + 7 * 4, 6, 6, 4, "2", (int)SDL_SCANCODE_KP_2 },
    { 50 + 7 * 3, 8 + 7 * 4, 6, 6, 1, "6"
                                      "\xa5"
                                      "2",
      (int)SDL_SCANCODE_KP_6 << 8 | (int)SDL_SCANCODE_KP_2 },
